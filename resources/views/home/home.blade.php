            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="owl-carousel">
                        <!--post1-->
                        <div class="blog-item" style="background-image: url('{{ asset('home_assets') }}/img/blog/bg1.jpg')">
                        ...
                        <!--post2-->
                        <div class="blog-item" style="background-image: url('{{ asset('home_assets') }}/img/blog/bg2.jpg')">
                            <div class="blog-banner">
                                <div class="post-overly">
                                    <div class="post-overly-content">
                                        <div class="entry-cat">
                        ...
                        <!--post3-->
                        <div class="blog-item" style="background-image: url('{{ asset('home_assets') }}/img/blog/bg3.jpg')">
                            <div class="blog-banner">
                                <div class="post-overly">
                                    <div class="post-overly-content">
                                        <div class="entry-cat">
                    ...
                    <div class="col-lg-12 ">
                        <div class="categories-items">
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/1.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/2.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/3.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/4.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/5.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/6.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/7.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/8.jpg" alt="">
                                </div>
                            ...
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/9.jpg" alt="">
                                </div>
                                <p>healty <span>11</span></p>
                            </a>
                            <a class="category-item" href="#">
                                <div class="image">
                                    <img src="{{ asset('home_assets') }}/img/categories/10.jpg" alt="">
                                </div>
                ...
                <div class="col-lg-8 oredoo-content">
                    <div class="theiaStickySidebar">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/31.jpg" alt="">
                                </a>
                            </div>
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/21.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/32.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/17.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/27.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/39.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/30.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/25.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                        ...
                        <div class="post-list post-list-style4">
                            <div class="post-list-image">
                                <a href="post-single.html">
                                    <img src="{{ asset('home_assets') }}/img/blog/22.jpg" alt="">
                                </a>
                            </div>
                            <div class="post-list-content">
                                <ul class="entry-meta">
                                ...
                                <ul class="widget-popular-posts">
                                    ...
                                    <li class="small-post">
                                        <div class="small-post-image">
                                            <a href="post-single.html">
                                                <img src="{{ asset('home_assets') }}/img/blog/1.jpg" alt="">
                                    ...
                                    <li class="small-post">
                                        <div class="small-post-image">
                                            <a href="post-single.html">
                                                <img src="{{ asset('home_assets') }}/img/blog/5.jpg" alt="">
                                    ...
                                    <li class="small-post">
                                        <div class="small-post-image">
                                            <a href="post-single.html">
                                                <img src="{{ asset('home_assets') }}/img/blog/13.jpg" alt="">
                                    ...
                                    <li class="small-post">
                                        <div class="small-post-image">
                                            <a href="post-single.html">
                                                <img src="{{ asset('home_assets') }}/img/blog/16.jpg" alt="">
